...
var Select = function (_React$Component) {
	...
	_createClass(Select, [{
		...
		value: function componentWillMount() {
			...
			this.handleResize = _lodash2.default.throttle(this.setPlacement, 100);
			this.handleScroll = _lodash2.default.throttle(this.setPlacement.bind(this, true), 50);
		}
	}, {
   ...
   */
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			if (this.props.autosize) {
				return _react2.default.createElement(_reactInputAutosize2.default, _extends({ id: this.props.id }, inputProps, { minWidth: '5', style: _extends({}, this.props.inputStyle) }));
			}
			return _react2.default.createElement(
				'div',
...
Select.propTypes = {
	...
	id: _propTypes2.default.string, // String to set at the input the a custom id, you can use it for the browser test
	...
	isOpen: _propTypes2.default.bool // open/close menu from outside
};
