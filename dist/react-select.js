(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('prop-types'), require('react-dom'), require('react-input-autosize'), require('classnames'), require('react-event-listener'), require('lodash')) :
	typeof define === 'function' && define.amd ? define(['react', 'prop-types', 'react-dom', 'react-input-autosize', 'classnames', 'react-event-listener', 'lodash'], factory) :
	(global.Select = factory(global.React,global.PropTypes,global.ReactDOM,global.AutosizeInput,global.classNames,global.EventListener,global._));
}(this, (function (React,PropTypes,ReactDOM,AutosizeInput,classNames,EventListener,_) { 'use strict';
...
EventListener = EventListener && EventListener.hasOwnProperty('default') ? EventListener['default'] : EventListener;
   ...
   */
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			if (this.props.autosize) {
				return React__default.createElement(AutosizeInput, _extends({ id: this.props.id }, inputProps, { minWidth: '5', style: _extends({}, this.props.inputStyle) }));
			}
			return React__default.createElement(
				'div',
		...
		value: function getAnchorPosition(el) {
			if (!el) {
				el = ReactDOM__default.findDOMNode(this);
			}

			var rect = ReactDOM__default.findDOMNode(this).getBoundingClientRect();
			var a = {
				top: rect.top,
				left: rect.left,
		...
		value: function setPlacement(scrolling) {
			...
			var anchor = this.getAnchorPosition(ReactDOM__default.findDOMNode(this.wrapper));
		...
		value: function render() {
			...
			var isOpen = this.state.isOpen || this.props.isOpen;
			...
			return React__default.createElement(
				...
				React__default.createElement(
					...
					React__default.createElement(RenderToLayer, {
						ref: 'layer',
						open: isOpen,
